...
export interface ErrorModelNamenamespacejavatimenameLocalDateTime {
...
export interface NvWaBuTianLaoBing {
  ...
  /** 行为数量 */
  blacklistRecordCnt?: (number | string)
  ...
  sex?: string
  /** 四库门牌号数量 */
  sikuCertificateCnt?: (number | string)
...
export interface XiLanHuaLieBiao {
  ...
  /** 彩虹西蓝花在摇篮中心的西蓝花ID */
  emoEnterpriseId?: (number | string)
  /** 彩虹西蓝花的-摇篮ID */
  emoSkyId?: (number | string)
  /** 西蓝花管理员姓名 */
  headerName?: string
  /** 西蓝花管理员电话 */
  headerPhone?: string
  /** 西蓝花管理员ID-摇篮中心小蚂蚁ID */
  headerUserId?: (number | string)
  /** 西蓝花ID */
  id?: (number | string)
  /** 介绍人id */
  introduceEarthId?: (number | string)
  /** 介绍人 */
